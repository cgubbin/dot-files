  ...
  wayland.windowManager.hyprland.settings = mkIf (cfg.hyprland.enable && pkgs.stdenv.isLinux) {
    ...
    bind =
      [
        ...
        "SUPER,KP_Subtract,layoutmsg,splitratio,-0.25"
        "SUPERSHIFT,KP_Subtract,layoutmsg,splitratio,-0.3333333"

        "SUPER,KP_Add,layoutmsg,splitratio,0.25"
        "SUPERSHIFT,KP_Add,layoutmsg,splitratio,0.3333333"
